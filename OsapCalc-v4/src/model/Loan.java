...
public class Loan {
	...
	public double computeMonthlyPayment(String rawPrincipal, String rawAnnualInterest, String rawPaymentPeriod, String rawGrace, String rawGracePeriod, String rawFixedInterest) throws Exception{
		...
		Double monthlyPaymentsWithoutGrace = computePayment(rawPrincipal, rawAnnualInterest, rawPaymentPeriod, rawGrace, rawGracePeriod, rawFixedInterest);
	...
	public double computePayment(String rawPrincipal, String rawAnnualInterest, String rawPaymentPeriod, String rawGrace, String rawGracePeriod, String rawFixedInterest) throws Exception{		
