...
public class SisModel {
	...
	public String restGET(String name) throws Exception {
		String result = exportXML(name, "0");
		
		return result;
	}
	
	public String restCREATE(String sid, String givenName, String surName, String creditTaken, String creditGraduate) throws Exception {
		int intCreditTaken = Integer.parseInt(creditTaken);
		int intCreditGraduate = Integer.parseInt(creditGraduate);
		
		int DAOResult = this.studentDAO.restInsert(sid, givenName, surName, intCreditTaken, intCreditGraduate);
		
		String result = "insertedRows:" + DAOResult;
		return result;
	}
	
	public String restDELETE(String sid) throws Exception {
		
		int DAOResult = this.studentDAO.restDelete(sid);
		String result = "deletedRows:" + DAOResult;
